  ...
  return (
    <FadeInWhenVisible delay={delay}>
      <div className="flex flex-col md:flex-row gap-6 p-6 md:p-8 bg-white rounded-3xl border border-green-50 hover:border-green-200 shadow-sm hover:shadow-lg transition-all duration-300">
        <div className="w-16 h-16 flex-shrink-0 bg-gradient-to-br from-blue-500 to-emerald-600 rounded-2xl flex items-center justify-center text-white text-2xl font-bold shadow-lg shadow-green-200">
          {number}
        </div>
        <div>
      ...
      <div className={`relative p-8 rounded-3xl transition-all duration-300 ${popular
        ...
        <Link
          ...
          className={`block w-full py-3 px-6 rounded-xl text-center font-semibold transition-all duration-300 ${popular
            ? 'bg-blue-600 text-white hover:bg-green-700 shadow-lg shadow-green-200 hover:shadow-xl'
            : 'bg-green-50 text-blue-700 hover:bg-green-100'
            }`}
        >
          Get Started
        </Link>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-blue-600 to-emerald-500 flex items-center justify-center shadow-lg shadow-green-200">
            ...
            <nav className="hidden lg:flex items-center gap-8">
              ...
              {session ? (
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Link
                    href="/register"
                    className="px-5 py-2.5 bg-gradient-to-r from-blue-600 to-blue-600 text-white rounded-xl text-sm font-semibold hover:shadow-lg hover:shadow-green-200 hover:-translate-y-0.5 transition-all duration-300"
                  >
                    Get Started
                  </Link>
                </div>
